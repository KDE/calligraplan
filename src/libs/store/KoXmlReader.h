...
/**
 * Converts @p element with children into QDomElements and adds them @p qdoc
 */
KOSTORE_EXPORT void toQDomDocument(const KoXmlElement& element, QDomDocument &qdoc);
